...
async function UpdateEventFromCSV(client, event_name) {
  ...
  for (const record of records) {
    const query = {
      text:
        "UPDATE " +
        event_name +
        " SET left_player_id = $1, right_player_id = $2 WHERE id = $3",
      values: [
        record.left_player_id !== "" ? parseInt(record.left_player_id) : null,
  ...
  let query =
    "UPDATE " +
    event_name +
    " SET left_player_flag=null, left_retire=null, right_retire=null";
