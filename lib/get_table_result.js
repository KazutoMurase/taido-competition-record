...
export async function GetTableResult(event_name) {
  ...
  if (event_name.includes("tenkai")) {
    query =
      "SELECT t1.id, t1.round, t1.main_score, t1.sub1_score, t1.sub2_score, t1.sub3_score, t1.sub4_score, t1.sub5_score, t1.elapsed_time, t1.penalty, t1.start_penalty, t1.retire, t2.name FROM " +
      event_name +
      " AS t1 LEFT JOIN " +
      groups_name +
