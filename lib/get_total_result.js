  ...
  for (const elem of event_result.rows) {
    if (elem.name_en.includes("finished")) {
      ...
      if (elem.name_en.includes("tenkai")) {
        query =
          "SELECT t1.id, t2.group_id, t1.round, t1.main_score, t1.sub1_score, t1.sub2_score, t1.sub3_score, t1.sub4_score, t1.sub5_score, t1.elapsed_time, t1.penalty, t1.start_penalty FROM " +
          elem.name_en +
          " AS t1 LEFT JOIN " +
          groups_name +
